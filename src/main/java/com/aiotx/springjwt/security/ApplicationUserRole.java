...
public enum ApplicationUserRole {
    ...
    ADMIN("ADMIN", Sets.newHashSet(ADMIN_READ, ADMIN_WRITE, MANAGER_READ, MANAGER_WRITE, USER_READ, USER_WRITE)),
    MANAGER("MANAGER", Sets.newHashSet(MANAGER_READ, MANAGER_WRITE, USER_READ, USER_WRITE)),
    USER("USER", Sets.newHashSet(USER_READ, USER_WRITE));
